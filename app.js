...
document.write(
  "<h2>My favourite phone is: " + favoriteModel + "</h2>" + "<br>",
  "<h2>The length of your favorite mobile phone model is: " +
    lengthOfInput +
    "</h2>"
);
...
document.write(
  "<br>",
  "<h2>The message after replacement is: " + replacedMessage + "</h2>"
);
...
if (found) {
  document.write(
    "<br>",
    "<h2>",
    userInput + " is availabe at index:",
    A.indexOf(userInput),
    "</h2>"
  );
} else {
...
var capitalizedCityName =
  cityName.slice(0).toUpperCase() + cityName.slice(1).toLowerCase();
...
document.write(
  "<br>",
  "The index of the first character of the last instance of 'go': " + indx
);
...
if (indexNum >= 0 && indexNum < str.length) {
  document.write(
    "<br>",
    "Segment at index " + indexNum + " exists in the string."
  );
} else {
  document.write(
    "<br>",
    "Segment at index " + indexNum + " does not exist in the string."
  );
}
